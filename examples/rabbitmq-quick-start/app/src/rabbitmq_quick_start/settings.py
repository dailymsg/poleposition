...
class Settings(BaseSettings):
    app_name: str = "rabbitmq_quick_start"
    ...
    auth_issuer: str = "rabbitmq_quick_start"
    # polepos:auth-settings
    rabbitmq_enabled: bool = True
    rabbitmq_url: str = "amqp://guest:guest@localhost:5672/"
    rabbitmq_client_id: str = "rabbitmq_quick_start"
    rabbitmq_exchange: str = "greetings.events"
    rabbitmq_exchange_type: str = "topic"
    rabbitmq_exchange_durable: bool = True
    rabbitmq_default_routing_key: str = "greetings.created"
    rabbitmq_default_queue: str = "greetings.demo"
