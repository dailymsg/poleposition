...
from rabbitmq_quick_start.modules.greetings.router import router as greetings_router
from rabbitmq_quick_start.modules.status.router import router as status_router
