...
class Settings(BaseSettings):
    app_name: str = "kafka_quick_start"
    ...
    auth_issuer: str = "kafka_quick_start"
    # polepos:auth-settings
    kafka_enabled: bool = True
    kafka_bootstrap_servers: str = "localhost:9092"
    kafka_client_id: str = "kafka_quick_start"
    kafka_default_topic: str = "greetings"
    kafka_group_id: str = "greetings-demo"
