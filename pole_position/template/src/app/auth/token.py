...
from {{project_import_name}}.auth.schemas import TokenPayload
from {{project_import_name}}.domain.exceptions import AuthenticationError
from {{project_import_name}}.settings import Settings, get_settings
